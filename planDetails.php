...
/*
 * This PHP Script displays detailed information about a specific plan based on a provided ID from the plans.php page.
 * Includes error handling for invalid plan IDs and uses a foreach to iterate through each detail of the plan
 * from the $results array which fetches the results of the SQL statement to select all plans.
*/
...
if (!empty($PlanID) && is_numeric($PlanID)) {
    ...
    $stmt = $con->prepare("SELECT * FROM Plane WHERE PlanID = :PlanID");
    ...
    if ($result) {
        ...
        <div class="row" style="padding: 6rem 2rem 2rem 2rem;">
            ...
            <div class="col-lg-2 mb-3 d-flex justify-content-center align-items-center backButtonDiv">
                <a href="plans.php" class="backButtonLink">
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div style="width:100%; height:100%; text-align: right">
                    <h5 class="card-title fs-6 pb-1"> <b><?php echo $result["Planname"]; ?></b> </h5>
                    <img src="<?php echo $result["filePath"]; ?>" class="card-img-top mx-auto" alt="..." style="width: 100%">
                    <div class="card-body text-start pt-2">
                        <div class="card-title"> <?php echo $result["Plandescription"]; ?></div>
                    </div>
                </div>
